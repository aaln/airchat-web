...
export async function GET(request: Request) {
    ...
    const activityStreamClient = new ActivityStreamAPIClient(airchatHostUrl, grpc.credentials.createSsl());
    ...
    return new Promise<Response>((resolve, reject) => {
        activityStreamClient.activityStream(activityStreamReq, metadata, (error: grpc.ServiceError | null, response: any) => {
            if (error) {
                ...
                resolve(new Response(JSON.stringify(respObj), { status: 200, headers: { 'Content-Type': 'application/json' } }));
            }
        });
    });
}