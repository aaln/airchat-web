...
export async function GET(request: Request) {
    ...
    const userClient = new UserAPIClient(airchatHostUrl, grpc.credentials.createSsl());
    ...
    return new Promise<Response>((resolve, reject) => {
        userClient.getUserWithAnalytics(getUserWithAnalyticsReq, metadata, (error, response) => {
            if (error) {
