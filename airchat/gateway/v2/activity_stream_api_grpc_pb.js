...
function serialize_airchat_gateway_v2_ActivityStreamRequest(arg) {
  if (!(arg instanceof airchat_gateway_v2_activity_stream_api_pb.ActivityStreamRequest)) {
    throw new Error('Expected argument of type airchat.gateway.v2.ActivityStreamRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_gateway_v2_ActivityStreamRequest(buffer_arg) {
  return airchat_gateway_v2_activity_stream_api_pb.ActivityStreamRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_airchat_gateway_v2_ActivityStreamResponse(arg) {
  if (!(arg instanceof airchat_gateway_v2_activity_stream_api_pb.ActivityStreamResponse)) {
    throw new Error('Expected argument of type airchat.gateway.v2.ActivityStreamResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_gateway_v2_ActivityStreamResponse(buffer_arg) {
  return airchat_gateway_v2_activity_stream_api_pb.ActivityStreamResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
activityStream: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: airchat_gateway_v2_activity_stream_api_pb.ActivityStreamRequest,
    responseType: airchat_gateway_v2_activity_stream_api_pb.ActivityStreamResponse,
...
exports.ActivityStreamAPIClient = grpc.makeGenericClientConstructor(ActivityStreamAPIService);
