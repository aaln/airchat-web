...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.airchat.gateway.v2.Status.displayName =
    'proto.airchat.gateway.v2.Status';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.airchat.gateway.v2.StatusSubscription = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.airchat.gateway.v2.StatusSubscription.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.airchat.gateway.v2.StatusSubscription.displayName =
    'proto.airchat.gateway.v2.StatusSubscription';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.airchat.gateway.v2.Status.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.airchat.gateway.v2.Status.deserializeBinary = function (bytes) {
  ...
  return proto.airchat.gateway.v2.Status.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.airchat.gateway.v2.Status}
 */
proto.airchat.gateway.v2.Status.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        break;
      case 3:
        var value = /** @type {!proto.airchat.gateway.v2.StatusType} */ (
          reader.readEnum()
        );
        msg.setType(value);
        break;
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.airchat.gateway.v2.Status.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
proto.airchat.gateway.v2.Status.prototype.getType = function () {
  return /** @type {!proto.airchat.gateway.v2.StatusType} */ (
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.airchat.gateway.v2.StatusSubscription.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.airchat.gateway.v2.StatusSubscription.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.airchat.gateway.v2.StatusSubscription.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
proto.airchat.gateway.v2.StatusSubscription.deserializeBinary = function (
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.airchat.gateway.v2.StatusSubscription();
  return proto.airchat.gateway.v2.StatusSubscription.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription}
 */
proto.airchat.gateway.v2.StatusSubscription.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.airchat.gateway.v2.StatusSubscription.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.airchat.gateway.v2.StatusSubscription.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.getStreamId =
  function () {
 ...
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setStreamId = function (
  value
) {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.clearStreamId =
  function () {
 ...
 * @return {boolean}
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.hasStreamId =
  function () {
 ...
 * @return {!Array<string>}
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.getUserIdList =
  function () {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setUserIdList = function (
  value
) {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.addUserId = function (
  value,
  opt_index
) {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.clearUserIdList =
  function () {
 ...
 * @return {string}
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.getSubscriberUserId =
  function () {
    return /** @type {string} */ (
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setSubscriberUserId =
  function (value) {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setAction = function (
  value
) {
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setAppend = function (
  value
) {
 ...
 * @return {boolean}
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.getNewConnection =
  function () {
    return /** @type {boolean} */ (
 ...
 * @return {!proto.airchat.gateway.v2.StatusSubscription} returns this
 */
proto.airchat.gateway.v2.StatusSubscription.prototype.setNewConnection =
  function (value) {
