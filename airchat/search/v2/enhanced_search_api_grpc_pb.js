...
function serialize_airchat_search_v2_ChannelSearchRequest(arg) {
  if (
    !(
      arg instanceof
      airchat_search_v2_enhanced_search_api_pb.ChannelSearchRequest
    )
  ) {
    throw new Error(
      'Expected argument of type airchat.search.v2.ChannelSearchRequest'
    );
  }
...
function deserialize_airchat_search_v2_ChannelSearchRequest(buffer_arg) {
  return airchat_search_v2_enhanced_search_api_pb.ChannelSearchRequest.deserializeBinary(
...
function serialize_airchat_search_v2_ChannelSearchResponse(arg) {
  if (
    !(
      arg instanceof
      airchat_search_v2_enhanced_search_api_pb.ChannelSearchResponse
    )
  ) {
    throw new Error(
      'Expected argument of type airchat.search.v2.ChannelSearchResponse'
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_airchat_search_v2_ChannelSearchResponse(buffer_arg) {
  return airchat_search_v2_enhanced_search_api_pb.ChannelSearchResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function serialize_airchat_search_v2_MessageSearchRequest(arg) {
  if (
    !(
      arg instanceof
      airchat_search_v2_enhanced_search_api_pb.MessageSearchRequest
    )
  ) {
    throw new Error(
      'Expected argument of type airchat.search.v2.MessageSearchRequest'
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_airchat_search_v2_MessageSearchRequest(buffer_arg) {
  return airchat_search_v2_enhanced_search_api_pb.MessageSearchRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function serialize_airchat_search_v2_MessageSearchResponse(arg) {
  if (
    !(
      arg instanceof
      airchat_search_v2_enhanced_search_api_pb.MessageSearchResponse
    )
  ) {
    throw new Error(
      'Expected argument of type airchat.search.v2.MessageSearchResponse'
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_airchat_search_v2_MessageSearchResponse(buffer_arg) {
  return airchat_search_v2_enhanced_search_api_pb.MessageSearchResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
exports.EnhancedSearchAPIClient = grpc.makeGenericClientConstructor(
  EnhancedSearchAPIService
);
