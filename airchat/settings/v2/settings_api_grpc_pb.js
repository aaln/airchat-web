...
function serialize_airchat_settings_v2_GetSettingsRequest(arg) {
  if (!(arg instanceof airchat_settings_v2_settings_api_pb.GetSettingsRequest)) {
    throw new Error('Expected argument of type airchat.settings.v2.GetSettingsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_settings_v2_GetSettingsRequest(buffer_arg) {
  return airchat_settings_v2_settings_api_pb.GetSettingsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_airchat_settings_v2_GetSettingsResponse(arg) {
  if (!(arg instanceof airchat_settings_v2_settings_api_pb.GetSettingsResponse)) {
    throw new Error('Expected argument of type airchat.settings.v2.GetSettingsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_settings_v2_GetSettingsResponse(buffer_arg) {
  return airchat_settings_v2_settings_api_pb.GetSettingsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_airchat_settings_v2_UpdateSettingsRequest(arg) {
  if (!(arg instanceof airchat_settings_v2_settings_api_pb.UpdateSettingsRequest)) {
    throw new Error('Expected argument of type airchat.settings.v2.UpdateSettingsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_settings_v2_UpdateSettingsRequest(buffer_arg) {
  return airchat_settings_v2_settings_api_pb.UpdateSettingsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_airchat_settings_v2_UpdateSettingsResponse(arg) {
  if (!(arg instanceof airchat_settings_v2_settings_api_pb.UpdateSettingsResponse)) {
    throw new Error('Expected argument of type airchat.settings.v2.UpdateSettingsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_airchat_settings_v2_UpdateSettingsResponse(buffer_arg) {
  return airchat_settings_v2_settings_api_pb.UpdateSettingsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
exports.SettingsAPIClient = grpc.makeGenericClientConstructor(SettingsAPIService);
