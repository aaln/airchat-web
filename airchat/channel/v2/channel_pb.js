...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.airchat.channel.v2.Channel.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.airchat.channel.v2.ChannelInviteCode.displayName =
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.airchat.channel.v2.ChannelParticipantInvite.displayName =
    'proto.airchat.channel.v2.ChannelParticipantInvite';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.airchat.channel.v2.Channel.prototype.toObject = function (
    opt_includeInstance
  ) {
  ...
  proto.airchat.channel.v2.Channel.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        isAllowedToJoin: jspb.Message.getBooleanFieldWithDefault(
          msg,
          10,
          false
        ),
...
proto.airchat.channel.v2.Channel.deserializeBinary = function (bytes) {
  ...
  return proto.airchat.channel.v2.Channel.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.airchat.channel.v2.Channel}
 */
proto.airchat.channel.v2.Channel.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.airchat.channel.v2.Channel.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.airchat.channel.v2.Channel} returns this
 */
proto.airchat.channel.v2.Channel.prototype.setParticipantCount = function (
  value
) {
 ...
 * @return {!proto.airchat.channel.v2.Channel} returns this
 */
proto.airchat.channel.v2.Channel.prototype.setIsAllowedToJoin = function (
  value
) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.airchat.channel.v2.ChannelInviteCode.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.airchat.channel.v2.ChannelInviteCode.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.airchat.channel.v2.ChannelInviteCode.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
proto.airchat.channel.v2.ChannelInviteCode.deserializeBinary = function (
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.airchat.channel.v2.ChannelInviteCode();
  return proto.airchat.channel.v2.ChannelInviteCode.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.airchat.channel.v2.ChannelInviteCode}
 */
proto.airchat.channel.v2.ChannelInviteCode.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.airchat.channel.v2.ChannelInviteCode.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.airchat.channel.v2.ChannelInviteCode.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.getChannelId =
  function () {
    return /** @type {string} */ (
 ...
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.setChannelId = function (
  value
) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.getInviteCode =
  function () {
    return /** @type {string} */ (
 ...
 * @return {!proto.airchat.channel.v2.ChannelInviteCode} returns this
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.setInviteCode = function (
  value
) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.getCreatedDate =
  function () {
    return /** @type{?proto.google.protobuf.Timestamp} */ (
      jspb.Message.getWrapperField(
        this,
 ...
 * @return {!proto.airchat.channel.v2.ChannelInviteCode} returns this
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.setCreatedDate = function (
  value
) {
 ...
 * @return {!proto.airchat.channel.v2.ChannelInviteCode} returns this
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.clearCreatedDate =
  function () {
    return this.setCreatedDate(undefined);
  };
 ...
 * @return {boolean}
 */
proto.airchat.channel.v2.ChannelInviteCode.prototype.hasCreatedDate =
  function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.airchat.channel.v2.ChannelParticipantInvite.prototype.toObject =
    function (opt_includeInstance) {
      return proto.airchat.channel.v2.ChannelParticipantInvite.toObject(
        opt_includeInstance,
        this
      );
    };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.airchat.channel.v2.ChannelParticipantInvite.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        channelId: jspb.Message.getFieldWithDefault(msg, 1, ''),
        participant:
          (f = msg.getParticipant()) &&
          airchat_user_v2_user_pb.User.toObject(includeInstance, f),
        createdDate:
          (f = msg.getCreatedDate()) &&
          google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
        lastUpdatedDate:
          (f = msg.getLastUpdatedDate()) &&
          google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
      };
 ...
 */
proto.airchat.channel.v2.ChannelParticipantInvite.deserializeBinary = function (
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.airchat.channel.v2.ChannelParticipantInvite();
  return proto.airchat.channel.v2.ChannelParticipantInvite.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.airchat.channel.v2.ChannelParticipantInvite.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 * @return {string}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.getChannelId =
  function () {
    return /** @type {string} */ (
      jspb.Message.getFieldWithDefault(this, 1, '')
    );
 ...
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.setChannelId =
  function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
  };
 ...
 * @return {?proto.airchat.user.v2.User}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.getParticipant =
  function () {
    return /** @type{?proto.airchat.user.v2.User} */ (
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.setParticipant =
  function (value) {
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.clearParticipant =
  function () {
 ...
 * @return {boolean}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.hasParticipant =
  function () {
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.getCreatedDate =
  function () {
    return /** @type{?proto.google.protobuf.Timestamp} */ (
      jspb.Message.getWrapperField(
        this,
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.setCreatedDate =
  function (value) {
    return jspb.Message.setWrapperField(this, 3, value);
  };
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.clearCreatedDate =
  function () {
    return this.setCreatedDate(undefined);
  };
 ...
 * @return {boolean}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.hasCreatedDate =
  function () {
    return jspb.Message.getField(this, 3) != null;
  };
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.getLastUpdatedDate =
  function () {
    return /** @type{?proto.google.protobuf.Timestamp} */ (
      jspb.Message.getWrapperField(
        this,
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.setLastUpdatedDate =
  function (value) {
    return jspb.Message.setWrapperField(this, 4, value);
  };
 ...
 * @return {!proto.airchat.channel.v2.ChannelParticipantInvite} returns this
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.clearLastUpdatedDate =
  function () {
 ...
 * @return {boolean}
 */
proto.airchat.channel.v2.ChannelParticipantInvite.prototype.hasLastUpdatedDate =
  function () {
    return jspb.Message.getField(this, 4) != null;
  };
