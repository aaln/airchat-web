...
export function OTPForm() {
  ...
  return (
    <Card className="w-full max-w-lg flex flex-col items-center gap-3 w-[580px] h-[400px] bg-white border border-transparent shadow-xl rounded-xl ">
      ...
      <CardContent className="w-full flex flex-col gap-8">
        <div className="w-full flex gap-4">
          <Label className="text-sm w-[200px]">
            Phone number (including area code):
          </Label>
          <Input
           
            className="w-full font-white bg-white"
            required type="tel"
