...
export default function UploadContainer() {
    ...
    const handleUpload = async () => {
        ...
        const readyUploadSegmentResponse = await fetch(`/api/raw/ReadyUploadSegment?id=${recordingId}`);
        ...
        try {
            ...
            reader.onloadend = async function () {
                ...
                const completeUploadResponse = await fetch(`/api/raw/CompleteUpload?id=${recordingId}`);
